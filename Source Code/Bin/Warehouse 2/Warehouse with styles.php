...
if ($page > 1) {
    echo "<a class='text-link' href='?page=" . ($page - 1) . "&WarehouseID=" . $selected_warehouse . "'>Previous</a> ";
}
if ($page < $total_pages) {
    echo "<a class='text-link' href='?page=" . ($page + 1) . "&WarehouseID=" . $selected_warehouse . "'>Next</a>";
}
